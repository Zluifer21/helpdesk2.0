...
public user: User;
  ...
  ngOnInit() {
    ...
    this._tickets.getTicket().subscribe(res=>{this.tickets=res; console.log(this.tickets);},err=>{console.log(err);});
...
myTicketsByFilter()
{
  this._tickets.myTicketsByFilters(this.myTicketsByFilters).subscribe(res=>{this.tickets=res;},err=>{console.log(err);})
}
...
TicketsByFilter()
{
  this._tickets.TicketsByFilters(this.ticketByFilters).subscribe(res=>{this.tickets=res},err=>{console.log(err)});
}
